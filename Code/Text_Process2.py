...
sentence_statistic = open('D:\DataMiningCourse\加贺系列输出\\sentence_statistic.txt', 'w', encoding='utf-8', errors='ignore')
data_file = open('D:\DataMiningCourse\加贺系列输出\\data_file.data', 'w', encoding='utf-8', errors='ignore')
sentence_style_list = []
...
for book in seg_list_file_addr:
    ...
    Passive_cnt = 0
    temp_style_list = []
    text_list = open('D:\DataMiningCourse\加贺恭一郎系列\\' + book, 'r', errors='ignore')
    text_list2 = open('D:\DataMiningCourse\\加贺小说人物(1).txt', 'r', encoding='utf-8')
    sentence_output = open('D:\DataMiningCourse\加贺系列输出\\' + book + '_sentence_output.txt', 'w', encoding='utf-8', errors='ignore')  # ,encoding='utf-8', errors='ignore'
    ...
    temp_style_list = [State_cnt/1.0/sentence_num, Quest_cnt/1.0/sentence_num, Reverse_Quest_cnt/1.0/sentence_num, Active_cnt/1.0/sentence_num2, Passive_cnt/1.0/sentence_num2]
    ...
    dict_freq_n_list = []
    for i in range(10):
        dict_freq_n_list.append(dict_freq_n_sorted[i][1])
    fig = plt.figure(2)
    ax1 = plt.subplot(111)
    data = np.array(dict_freq_n_list)
    width = 0.2
    x_bar = np.arange(10)
    rect = ax1.bar(left=x_bar, height=data, width=width, color="lightblue")
    for rec in rect:
    ...
    dict_freq_v_list = []
    for i in range(10):
        dict_freq_v_list.append(dict_freq_v_sorted[i][1])
    fig = plt.figure(3)
    ax1 = plt.subplot(111)
    data = np.array(dict_freq_v_list)
    width = 0.2
    x_bar = np.arange(10)
    rect = ax1.bar(left=x_bar, height=data, width=width, color="lightblue")
    for rec in rect:
    ...
    dict_freq_adj_list = []
    for i in range(10):
        dict_freq_adj_list.append(dict_freq_adj_sorted[i][1])
    fig = plt.figure(4)
    ax1 = plt.subplot(111)
    data = np.array(dict_freq_adj_list)
    width = 0.2
    x_bar = np.arange(10)
    rect = ax1.bar(left=x_bar, height=data, width=width, color="lightblue")
    for rec in rect:
    ...
    plt.show()
    book.replace('.txt', ' ', 2)
    csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + book + 'dict_freq_n_sorted.csv', 'w', newline='')  # 设置newline，否则两行之间会空一行
    writer = csv.writer(csvFile)
    for i in range(len(dict_freq_n_sorted)):
        writer.writerow(dict_freq_n_sorted[i])
    csvFile.close()
    csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + book + 'dict_freq_v_sorted.csv', 'w', newline='')  # 设置newline，否则两行之间会空一行
    writer = csv.writer(csvFile)
    for i in range(len(dict_freq_v_sorted)):
        writer.writerow(dict_freq_v_sorted[i])
    csvFile.close()
    csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + book + 'dict_freq_adj_sorted.csv', 'w', newline='')  # 设置newline，否则两行之间会空一行
    writer = csv.writer(csvFile)
...
csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + 'series_active.csv', 'w',
...
csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + 'series_passive.csv', 'w',
               newline='')  # 设置newline，否则两行之间会空一行
writer = csv.writer(csvFile)
...
csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + 'series_state.csv', 'w',
               newline='')  # 设置newline，否则两行之间会空一行
writer = csv.writer(csvFile)
...
csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + 'series_quest.csv', 'w',
               newline='')  # 设置newline，否则两行之间会空一行
writer = csv.writer(csvFile)
...
csvFile = open('D:\DataMiningCourse\加贺系列输出\\' + 'series_rquest.csv', 'w',
               newline='')  # 设置newline，否则两行之间会空一行
writer = csv.writer(csvFile)
